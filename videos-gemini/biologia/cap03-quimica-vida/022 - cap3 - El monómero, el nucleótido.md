# 022 - cap3 - El monómero, el nucleótido

*Biología PAES — Ciencias · Capítulo 3: Química de la vida · Sección 7. Ácidos nucleicos · a. El monómero: el nucleótido*
...
- **Estilo visual:** Personalizado (base: Clásico / infografía molecular con modelos de esferas y barras, común a todo el Capítulo 3). Una pieza de tres partes que se encadena.
...
Enfócate solo en el apartado «a. El monómero: el nucleótido» de la sección «7. Ácidos nucleicos» de las fuentes; ignora el resto del capítulo y las preguntas.
Estructura:
1. Pregunta gancho (10 s): ¿de qué pieza está hecho el ADN?
2. Tres partes (60 s): un azúcar de cinco carbonos, un grupo fosfato y una base nitrogenada.
3. La cadena (60 s): los nucleótidos se unen a través del azúcar y el fosfato, que forman el esqueleto; las bases quedan hacia el interior.
4. Resumen final en 3 puntos (20 s): el nucleótido tiene tres partes; azúcar y fosfato forman el esqueleto; las bases quedan hacia adentro.
...
lentes de seguridad, que arma moléculas con un kit de esferas y barras. El símbolo de este video es una pieza de tres partes: un pentágono (azúcar), una esfera naranja (fosfato) y un rectángulo de color (base).

ESCENAS SEGÚN EL CONTENIDO:
- Gancho: una doble hélice que se acerca hasta mostrar una sola pieza.
- Tres partes: se arman el pentágono, la esfera naranja y la base, cada una rotulada.
- Cadena: las piezas se enganchan azúcar-fosfato-azúcar en una columna; las bases apuntan
  hacia el centro.
