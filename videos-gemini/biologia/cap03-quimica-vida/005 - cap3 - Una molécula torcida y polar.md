# 005 - cap3 - Una molécula torcida y polar

*Biología PAES — Ciencias · Capítulo 3: Química de la vida · Sección 3. El agua y las sales minerales · a. Una molécula torcida y polar*
...
- **Estilo visual:** Personalizado (base: Clásico / infografía molecular con modelos de esferas y barras, común a todo el Capítulo 3). La molécula de agua en ángulo, con cargas parciales.
...
Enfócate solo en el apartado «a. Una molécula torcida y polar» de la sección «3. El agua y las sales minerales» de las fuentes; ignora el resto del capítulo y las preguntas.
Estructura:
1. Pregunta gancho (10 s): ¿por qué una molécula tan pequeña explica tanto de la vida?
2. Forma no lineal (40 s): los dos hidrógenos forman un ángulo con el oxígeno.
3. Polaridad (60 s): el oxígeno atrae más los electrones; queda con carga parcial negativa y los hidrógenos con carga parcial positiva; la molécula es polar.
4. La red (50 s): cada molécula forma puentes de hidrógeno con varias vecinas y el conjunto se comporta como una red.
5. Resumen final en 3 puntos (20 s): el agua está doblada; es polar; forma una red de puentes de hidrógeno.
...
lentes de seguridad, que arma moléculas con un kit de esferas y barras. El símbolo de este video es una molécula de agua gigante en forma de V, con una nube roja sobre el oxígeno y dos nubes blancas sobre los hidrógenos.

ESCENAS SEGÚN EL CONTENIDO:
- Gancho: una gota de agua que se acerca hasta mostrar una sola molécula.
- Forma: la molécula en V con el ángulo marcado.
- Polaridad: símbolos δ− sobre el oxígeno y δ+ sobre los hidrógenos; la nube de electrones se
  inclina hacia el oxígeno.
- Red: muchas moléculas unidas por líneas punteadas formando una malla que se mueve.
