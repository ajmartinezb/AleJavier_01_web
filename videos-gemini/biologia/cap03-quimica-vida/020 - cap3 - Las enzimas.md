# 020 - cap3 - Las enzimas

*Biología PAES — Ciencias · Capítulo 3: Química de la vida · Sección 6. Proteínas y enzimas · d. Las enzimas*
...
- **Estilo visual:** Personalizado (base: Clásico / infografía molecular con modelos de esferas y barras, común a todo el Capítulo 3). Una llave y su cerradura bajan una colina.
...
Enfócate solo en el apartado «d. Las enzimas» de la sección «6. Proteínas y enzimas» de las fuentes; ignora el resto del capítulo y las preguntas.
Estructura:
1. Pregunta gancho (10 s): ¿cómo ocurren en segundos reacciones que tardarían años?
2. Qué es (40 s): una proteína que acelera una reacción sin consumirse, disminuyendo la energía de activación.
3. El ciclo (80 s): el sustrato se une al sitio activo; la unión es específica; la reacción ocurre y los productos se liberan; la enzima queda libre para repetir.
4. Un dato que decide preguntas (40 s): la enzima no cambia el resultado final ni vuelve posible lo imposible; solo la hace más rápida. Es falso que «aporte la energía» o «desplace el equilibrio».
5. Resumen final en 3 puntos (20 s): acelera sin consumirse; baja la energía de activación; es específica y reutilizable.
...
lentes de seguridad, que arma moléculas con un kit de esferas y barras. El símbolo de este video es una colina de energía dibujada como un gráfico, con un túnel que la enzima abre para bajarla.

ESCENAS SEGÚN EL CONTENIDO:
- Gancho: un reloj de arena lento frente a uno rapidísimo.
- Qué es: el gráfico de energía con una colina alta; la enzima baja la colina.
- Ciclo: una enzima con un sitio activo en forma de hueco; el sustrato encaja como llave; se
  corta en dos productos que salen; la enzima queda igual y vuelve a empezar.
- Dato: dos alternativas «aporta energía» y «desplaza el equilibrio» tachadas en magenta.
