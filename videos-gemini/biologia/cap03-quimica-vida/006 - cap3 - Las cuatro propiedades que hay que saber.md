# 006 - cap3 - Las cuatro propiedades que hay que saber

*Biología PAES — Ciencias · Capítulo 3: Química de la vida · Sección 3. El agua y las sales minerales · b. Las cuatro propiedades que hay que saber*
...
- **Estilo visual:** Personalizado (base: Clásico / infografía molecular con modelos de esferas y barras, común a todo el Capítulo 3). Cuatro escenas de la naturaleza que explica una sola molécula.
...
Enfócate solo en el apartado «b. Las cuatro propiedades que hay que saber» de la sección «3. El agua y las sales minerales» de las fuentes; ignora el resto del capítulo y las preguntas.
Estructura:
1. Pregunta gancho (10 s): ¿por qué el hielo flota y los lagos no se congelan hasta el fondo?
2. Disolvente (40 s): la polaridad rodea a los iones y los separa; casi todas las reacciones celulares ocurren en solución acuosa.
3. Alto calor específico (40 s): calentar el agua exige romper muchos puentes de hidrógeno; amortigua cambios de temperatura en el organismo y el clima.
4. Cohesión y tensión superficial (40 s): las moléculas se atraen; permite que la savia suba por los vasos de una planta.
5. El hielo flota (40 s): al congelarse, la red ocupa más volumen; el lago se congela arriba y la vida sigue debajo.
6. El agua no disuelve todo (30 s): disuelve bien lo polar e iónico, mal lo apolar; por eso los aceites no se mezclan.
7. Resumen final en 3 puntos (20 s): cuatro propiedades desde la polaridad; cada una sostiene la vida; no es disolvente universal.
...
lentes de seguridad, que arma moléculas con un kit de esferas y barras. El símbolo de este video es una red de moléculas de agua que aparece en cada escena, explicando cada propiedad desde dentro.

ESCENAS SEGÚN EL CONTENIDO:
- Gancho: un lago con hielo arriba y peces nadando abajo.
- Disolvente: un cristal de sal que se desarma, rodeado de moléculas de agua orientadas.
- Calor específico: un termómetro que sube lento mientras se rompen líneas punteadas.
- Cohesión: una planta con un tubo interior por donde sube una columna de moléculas unidas.
- Hielo: la red ordenada y más espaciada del hielo sobre el agua líquida más compacta.
- No todo: gotas de aceite apartadas del agua, con un rótulo en magenta.
