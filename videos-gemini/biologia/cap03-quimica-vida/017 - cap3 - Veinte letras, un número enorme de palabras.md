# 017 - cap3 - Veinte letras, un número enorme de palabras

*Biología PAES — Ciencias · Capítulo 3: Química de la vida · Sección 6. Proteínas y enzimas · a. Veinte letras, un número enorme de palabras*
...
- **Estilo visual:** Personalizado (base: Clásico / infografía molecular con modelos de esferas y barras, común a todo el Capítulo 3). Un alfabeto de veinte cuentas.
...
Enfócate solo en el apartado «a. Veinte letras, un número enorme de palabras» de la sección «6. Proteínas y enzimas» de las fuentes; ignora el resto del capítulo y las preguntas.
Estructura:
1. Pregunta gancho (10 s): con 27 letras escribimos todas las palabras del español. ¿Cuántas proteínas se escriben con 20 aminoácidos?
2. Polímeros de aminoácidos (40 s): unidos por enlaces peptídicos; veinte aminoácidos forman todas las proteínas de todos los seres vivos.
3. Diversidad (40 s): una cadena de cien aminoácidos admite una cantidad astronómica de combinaciones.
4. El grupo lateral (50 s): cada aminoácido tiene la misma parte central y un grupo lateral propio, polar, apolar o con carga, que decide cómo se plegará la cadena.
5. Resumen final en 3 puntos (20 s): veinte aminoácidos; combinaciones enormes; el grupo lateral decide el plegamiento.
...
lentes de seguridad, que arma moléculas con un kit de esferas y barras. El símbolo de este video es un collar de cuentas de veinte colores distintos, cada una con una letra.

ESCENAS SEGÚN EL CONTENIDO:
- Gancho: un teclado con letras que se convierte en cuentas de colores.
- Polímeros: cuentas que se enganchan con un enlace peptídico resaltado.
- Diversidad: cadenas muy largas con combinaciones distintas que se multiplican.
- Grupo lateral: cada cuenta con la misma base y una «antena» diferente (polar, apolar, con
  carga) que tira de la cadena al plegarse.
