# 021 - cap3 - Las variables que afectan a una enzima

*Biología PAES — Ciencias · Capítulo 3: Química de la vida · Sección 6. Proteínas y enzimas · e. Las variables que afectan a una enzima*
...
- **Estilo visual:** Personalizado (base: Clásico / infografía molecular con modelos de esferas y barras, común a todo el Capítulo 3). Cuatro gráficos de actividad enzimática.
...
Enfócate solo en el apartado «e. Las variables que afectan a una enzima» de la sección «6. Proteínas y enzimas» de las fuentes; ignora el resto del capítulo y las preguntas.
Estructura:
1. Pregunta gancho (10 s): si calientas una enzima, ¿trabaja siempre más rápido?
2. Temperatura (50 s): sube hasta un óptimo y cae de golpe porque la enzima se desnaturaliza; la curva es asimétrica.
3. pH (40 s): cada enzima tiene su óptimo; la pepsina cerca de pH 2, la amilasa salival cerca de pH 7.
4. Concentración de sustrato (40 s): la velocidad sube hasta una meseta de saturación cuando todas las enzimas están ocupadas.
5. Inhibidores (20 s): se unen a la enzima y reducen su actividad.
6. Cómo se pregunta (30 s): la caída brusca con la temperatura no es cansancio ni falta de sustrato; es pérdida de forma; la asimetría es la pista.
7. Resumen final en 3 puntos (20 s): temperatura y pH tienen un óptimo; el sustrato satura; la caída brusca es desnaturalización.
...
lentes de seguridad, que arma moléculas con un kit de esferas y barras. El símbolo de este video son cuatro pequeños gráficos dibujados en la mesa, con la enzima como un personaje que sube y baja por sus curvas.

ESCENAS SEGÚN EL CONTENIDO:
- Gancho: una enzima junto a una llama y un signo de pregunta.
- Temperatura: una curva que sube suave y cae abrupta; en la caída la enzima se deforma.
- pH: dos curvas con picos en pH 2 (estómago) y pH 7 (boca).
- Sustrato: una curva que se aplana; todas las enzimas ocupadas con sustratos en fila.
- Inhibidores: una pieza extraña que tapa el sitio activo.
- Cómo se pregunta: la caída asimétrica encerrada con «pierde su forma».
