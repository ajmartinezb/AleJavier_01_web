# 007 - cap2 - Los tres postulados

*Biología PAES — Ciencias · Capítulo 2: Niveles de organización y teoría celular · Sección 4. La teoría celular · a. Los tres postulados*
...
- **Estilo visual:** Personalizado (base: Acuarela / atlas con zoom de microscopio, común a todo el Capítulo 2). Tres pilares grabados como en una placa conmemorativa.
...
Enfócate solo en el apartado «a. Los tres postulados» de la sección «4. La teoría celular» de las fuentes; ignora el resto del capítulo y las preguntas.
Estructura:
1. Pregunta gancho (10 s): ¿qué afirma la teoría que explica de qué estamos hechos todos los seres vivos?
2. Primer postulado (40 s): todos los seres vivos están formados por una o más células.
3. Segundo postulado (40 s): la célula es la unidad estructural y funcional de la vida, la más pequeña capaz de realizar todas las funciones vitales.
4. Tercer postulado (40 s): toda célula proviene de otra célula preexistente.
5. Lo que implica el tercero (40 s): es el más tardío; no hay generación espontánea y existe continuidad desde las primeras células hasta hoy.
6. Resumen final en 3 puntos (20 s): todo ser vivo tiene células; la célula es la unidad; toda célula viene de otra.
...
que se ve cada escena. El símbolo de este video son tres pilares de piedra dibujados a tinta, cada uno con un postulado grabado, que sostienen una célula.

ESCENAS SEGÚN EL CONTENIDO:
- Gancho: un roble, una persona y una bacteria en tres lentes, todos llenos de células.
- Primer postulado: el primer pilar se levanta con organismos de una y muchas células.
- Segundo: el segundo pilar con una célula realizando funciones (comer, moverse, dividirse).
- Tercero: el tercer pilar con una célula dividiéndose en dos.
- Implicancia: una cadena de células madre e hijas que retrocede hasta perderse en el pasado.
