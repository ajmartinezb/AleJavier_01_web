# 012 - cap2 - Dos grandes tipos de células

*Biología PAES — Ciencias · Capítulo 2: Niveles de organización y teoría celular · Sección 5. Unidad y diversidad celular · b. Dos grandes tipos*
...
- **Estilo visual:** Personalizado (base: Acuarela / atlas con zoom de microscopio, común a todo el Capítulo 2). Dos células en corte lado a lado, como láminas de atlas.
...
Enfócate solo en el apartado «b. Dos grandes tipos» de la sección «5. Unidad y diversidad celular» de las fuentes; ignora el resto del capítulo y las preguntas.
Estructura:
1. Pregunta gancho (10 s): ¿qué criterio separa a todas las células del planeta en dos grupos?
2. Procarionte (60 s): sin núcleo definido, ADN en el nucleoide; sin organelos membranosos; 1 a 10 µm; bacterias y arqueas.
3. Eucarionte (60 s): núcleo con envoltura nuclear; organelos membranosos como mitocondrias, retículo y Golgi; 10 a 100 µm; protozoos, hongos, plantas y animales.
4. El criterio (30 s): la presencia o ausencia de un núcleo delimitado por membrana.
5. Resumen final en 3 puntos (20 s): procarionte sin núcleo; eucarionte con núcleo y organelos; el criterio es el núcleo.
...
que se ve cada escena. El símbolo de este video es una regla micrométrica dibujada bajo las dos células, que muestra su diferencia de tamaño.

ESCENAS SEGÚN EL CONTENIDO:
- Gancho: muchas células mezcladas que se ordenan en dos columnas.
- Procarionte: bacteria pequeña en corte con el nucleoide sin membrana y ribosomas; regla
  «1-10 µm».
- Eucarionte: célula grande con núcleo envuelto y organelos rotulados; regla «10-100 µm».
- Criterio: la lente se centra en el núcleo con envoltura, resaltado en amarillo polen.
